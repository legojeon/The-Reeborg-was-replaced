...
export function createObjectsFromList(height: number, list: NonNullable<World['objects']>): { group: Group, dispose: () => void } {
...
export function createObjects(world: World): { group: Group, dispose: () => void } {
  const group = new Group();
