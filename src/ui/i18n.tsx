...
const STRINGS: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'mk.descLabel': '미션 설명 (HTML 가능)',
    'mk.descPlaceholder': '<h1>제목</h1><p>설명...</p>',
  ...
  en: {
    ...
    'mk.descLabel': 'Mission description (HTML allowed)',
    'mk.descPlaceholder': '<h1>Title</h1><p>Description...</p>',
